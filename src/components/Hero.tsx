    ...
    if (layer === "red") {
        return (
            <section className="hero">
                ...
                <div
                    className="hero__decor hidden md:block absolute inset-0 pointer-events-none z-0"
                    aria-hidden="true"
                >
                    <span className="hero__decor-coord">ERR:404</span>
                    <span className="hero__decor-coord">NaN° LOL</span>
                    <div className="hero__decor-bracket" />
                    <div className="hero__decor-bracket" />
                    <div className="hero__decor-circle" />
                    <div className="hero__decor-circle" />
                    <div className="hero__decor-line" />
                    <div className="hero__decor-line" />
                    <div className="hero__decor-dot" />
                    <div className="hero__decor-dot" />
                    <div className="hero__decor-dot" />
                </div>
    ...
    return (
        <section className="hero" id="hero">
            ...
            <div className="hero__decor" aria-hidden="true">
                <span className="hero__decor-coord">28.6139° N</span>
                <span className="hero__decor-coord">77.2090° E</span>
                <div className="hero__decor-bracket" />
                <div className="hero__decor-bracket" />
                <div className="hero__decor-circle" />
                <div className="hero__decor-circle" />
